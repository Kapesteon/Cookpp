...
void debug()
{
	...
	InfoNutri * testInfoNutri2 = new InfoNutri(tab,7);
	InfoNutri * testInfoNutri3 = new InfoNutri(*testInfoNutri2);
	InfoNutri * testInfoNutri4 = new InfoNutri(tab2, 7);
	...
	Aliment testAliment4 = Aliment("Apple", "Fruit", "Winter", testInfoNutri3, 200);
